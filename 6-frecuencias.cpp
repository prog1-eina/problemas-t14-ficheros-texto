 ...
 *       de componentes del vector «frecuencias» es igual al número de letras
 *       del alfabeto inglés.
 * Post: Asigna a cada componente del vector «frecuencias» el número de
 *       apariciones de cada una de las letras del alfabeto inglés en el
 *       fichero cuyo nombre es «nombreFichero», no distinguiendo entre
 *       mayúsculas y minúsculas. La primera componente del vector es el
 *       número de veces que aparece la letra A, la segunda, las de la letra B
 *       y así sucesivamente.   
 */
...
/*
 * Pre:  El número de componentes del vector «frecuencias» es igual al número
 *       de letras del alfabeto inglés. La primera componente del vector es el
 *       número de veces que aparece la letra A, la segunda, las de la letra B
 *       y así sucesivamente.
 * Post: Escribe en la pantalla una tabla con las frecuencias de apariciones de
 *       las letras según los valores de las componentes del vector
 *       «frecuencias».
 */
