 ...
 *       corresponde a los siguientes datos de un estudiante, separados por
 *       espacios: NIP, grupo y nombre completo.
 *       «destino» es un flujo de salida asociado a un texto.
 * Post: Filtra el contenido del flujo «origen» para dejar, en el flujo
 *       «destino», solo el NIP y el nombre completo de cada estudiante que
 *       pertenece al grupo indicado por el valor del parámetro «grupo».
 */
 ...
 *       corresponde a los siguientes datos de un estudiante, separados por
 *       espacios en blanco: NIP, grupo y nombre completo.
 * Post: Filtra el contenido del fichero cuyo nombre es el valor de
 *       «nombreOrigen» para dejar, en un fichero cuyo nombre es el del
 *       valor del parámetro «nombreDestino», solo el NIP y el nombre completo
 *       de cada estudiante que pertenece al grupo indicado por el valor
 *       del parámetro «grupo».
 */
...
/*
 * Función de prueba. El fichero «estudiantes.txt» debe estar en el directorio
 * del proyecto, donde también se creará el fichero «estudiantes-tardes.txt».
